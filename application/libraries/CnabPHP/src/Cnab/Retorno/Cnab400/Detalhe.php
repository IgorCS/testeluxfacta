...
class Detalhe extends \Cnab\Format\Linha implements \Cnab\Retorno\IDetalhe
{
	...
	{		
		if(in_array($banco,array('1','1_7','1_6'))){
			$tipo_baixa = array(6,5);//codigo 5 para boletos pagos sem envio de remassas
		}elseif($banco=='341'){
			$tipo_baixa = array(10, 32, 47, 59, 72, 6); //removido codigo 9 - baixa pelo sistema do banco
		}else{
			return false;
		}
